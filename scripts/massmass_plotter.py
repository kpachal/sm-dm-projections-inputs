        ...
        with open('{0}_exclusion_contours_{1}.pkl'.format(model,collider), "rb") as poly_file:
            ...
            for gq in test_gq :
                ...
                for gl in test_gl :
                    ...
                    drawMassMassPlot(contours_list, legend_lines, this_tag = model+"_gq{0}_gdm1.0_gl{1}".format(gq, gl), plot_path = "plots/massmass/"+collider, addText=label_line)
                ...
                drawMassMassPlot(contours_list_couplingscan,legend_lines_couplingscan, this_tag = model+"_gq{0}_gdm1.0".format(gq), plot_path = "plots/massmass/"+collider, addText = label_line,is_scaling=True)
            ...
            for gl in test_gl :
                ...
                drawMassMassPlot(contours_list_couplingscan,legend_lines_couplingscan, this_tag = model+"_gl{0}_gdm1.0".format(gl), plot_path = "plots/massmass/"+collider, addText = label_line,is_scaling=True)            
