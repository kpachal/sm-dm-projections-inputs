            ...
            for gdm in test_gdm :
                for gq in test_gq :
                    ...
                    for gl in test_gl :
                        ...
                        drawMassMassPlot(contours_list, legend_lines, this_tag = model+"_gq{0}_gdm{1}_gl{2}".format(gq, gdm, gl), plot_path = "plots/massmass/"+collider, addText=label_line, xhigh=plotlims[collider][0], yhigh=plotlims[collider][1])
                    ...
                    for signature in ['dijet','monojet','dilepton'] :
                        ...
                        for gl in test_gl :
                            ...
                            contours_list.append(loaded_polygons[signature][(gq, gdm, gl)])
